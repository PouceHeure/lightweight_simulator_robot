...
#define NB_ROBOTS 10
#define NB_ELEMENTS_RESOURCES 2
#define NB_ELEMENTS_WALLS 50 
#define COEFF_ATTRACTIVE_FIELD 10
...
class MyRobot : public Robot {
    ...
    public:     
        ...
        :radius(_radius),counter_detecter(0),Robot(_name)
        {
...
void callbackRobotPerception(RobotInfo* robotInfo,std::vector<std::vector<Cell*>>& world,int lines, int cols){
    ...
    //std::cout << "robot: " << robotInfo->robot->getId() << std::endl;
    //std::cout << "x: " << robotInfo->position.getX() << " y:" << robotInfo->position.getY() << std::endl;
